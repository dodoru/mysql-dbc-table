...
const varStr = (value) => {
    ...
    throw new SqlArgsError('$varStr expect value of undefined, null，string, or number')
};
...
const trimString = (value) => {
    ...
    throw new SqlArgsError('$trimString expect value of undefined, null，string, or number')
}
